...
with column1:
    ...
    st.markdown('---')
    age_range_visual1 = st.slider("Age Range (Visualization 1)", int(df['Age'].min()), int(df['Age'].max()), (20, 60))
    gender_filter_visual1 = st.selectbox("Gender (Visualization 1)", ["All"] + df['Gender'].unique().tolist())
    marital_status_filter_visual1 = st.multiselect("Marital Status (Visualization 1)", df['Marital_status'].unique())
    payment_method_filter_visual1 = st.multiselect("Payment Method (Visualization 1)", df['Payment_method'].unique())
    segment_filter_visual1 = st.multiselect("Segment (Visualization 1)", df['Segment'].unique())
    state_filter_visual1 = st.multiselect("State Names (Visualization 1)", df['State_names'].unique())
    employee_status_filter_visual1 = st.multiselect("Employee Status (Visualization 1)", df['Employees_status'].unique())
...
with column2:
    ...
    st.write("COUNT PLOT OF GENDER")
    st.markdown('---')
    age_range_visual2 = st.slider("Age Range (Visualization 2)", int(df['Age'].min()), int(df['Age'].max()), (20, 60))
    gender_filter_visual2 = st.selectbox("Gender (Visualization 2)", ["All"] + df['Gender'].unique().tolist())
    marital_status_filter_visual2 = st.multiselect("Marital Status (Visualization 2)", df['Marital_status'].unique())
    payment_method_filter_visual2 = st.multiselect("Payment Method (Visualization 2)", df['Payment_method'].unique())
    segment_filter_visual2 = st.multiselect("Segment (Visualization 2)", df['Segment'].unique())
    state_filter_visual2 = st.multiselect("State Names (Visualization 2)", df['State_names'].unique())
    employee_status_filter_visual2 = st.multiselect("Employee Status (Visualization 2)", df['Employees_status'].unique())
...
with column1:
    ...
    st.write("Box plot of Amount Spent by Gender")  
    st.markdown('---')  
...
with column2:
    ...
    st.write("Scatter plot of Age vs Amount Spent") 
    st.markdown('---')
...
with column1:
    ...
    st.write("Bar plot of Average Amount Spent by Segment")
    st.markdown('---')
...
with column2:
    ...
    st.write("Pie chart of Payment Method Distribution")
    st.markdown('---')
...
with column1:
    ...
    st.write("Box plot of Amount Spent by State")
    st.markdown('---')
...
with column2:
    ...
    st.write("Line plot of Amount Spent over time")
    st.markdown('---')
